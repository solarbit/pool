...
-define(BDIFF, 26959535291011309493156476344723991336010898738574164086137773096960).
% pdiff: 0x00000000FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
-define(PDIFF, 26959946667150639794667015087019630673637144422540572481103610249215).
...
decode_coinbase(Bin = <<Version:32/little, Bin0/binary>>) ->
	{1, Bin0} = decode_integer(Bin),
	{TxIn, BlockHeight, Bin1} = decode_coinbase_input(Bin0),
...
decode_coinbase_input(<<Hash:256, Index:32/little, Bin/binary>>) ->
	...
	<<3, BlockHeight:24/little, Bin1/binary>> = Script, % TODO: should observe OP_PUSH
